          ...
          children: <Widget>[
            ModuleWidget(
                SubModuleWidgetGym(
                  'b1',
                  exercise:
                      gymData.firstWhere((exercise) => exercise.id == 'b1'),
                ),
                'Barbell Deadlift',
            ...
            ModuleWidget(
                SubModuleWidgetGym(
                  'b2',
                  exercise:
                      gymData.firstWhere((exercise) => exercise.id == 'b2'),
                ),
            ...
            ModuleWidget(
                SubModuleWidgetGym(
                  'b3',
                  exercise:
                      gymData.firstWhere((exercise) => exercise.id == 'b3'),
                ),
                'Wide-Grip Pull-Up',
            ...
            ModuleWidget(
                SubModuleWidgetGym(
                  'b4',
                  exercise:
                      gymData.firstWhere((exercise) => exercise.id == 'b4'),
                ),
                'Standing T-Bar Row',
            ...
            ModuleWidget(
                SubModuleWidgetGym(
                  'b5',
                  exercise:
                      gymData.firstWhere((exercise) => exercise.id == 'b5'),
                ),
                'Seated Cable Row',
            ...
            ModuleWidget(
                SubModuleWidgetGym(
                  'b6',
                  exercise:
                      gymData.firstWhere((exercise) => exercise.id == 'b6'),
                ),
            ...
            ModuleWidget(
                SubModuleWidgetGym(
                  'b7',
                  exercise:
                      gymData.firstWhere((exercise) => exercise.id == 'b7'),
                ),
            ...
            ModuleWidget(
                SubModuleWidgetGym(
                  'b8',
                  exercise:
                      gymData.firstWhere((exercise) => exercise.id == 'b8'),
                ),
